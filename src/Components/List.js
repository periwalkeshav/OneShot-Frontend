...
import '../List.css'
export default function List({ name, branch, year, city, studentNumber, id, removeCollege, fetchSimilarColleges, students, studentDetails }) {
                ...
                <div className='btn-container'>
                    ...
                    {enterBranch &&
                        <div>
                            <form >
                                <label>
                                    <p className="branch">Enter Branch </p>
                                    <input type="text" name="name" placeholder='e.g. CSE'
                                        value={branchName}
